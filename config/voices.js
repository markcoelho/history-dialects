...
class VoiceManager {
    ...
    getVoiceSettings(style) {
        ...
        const settingsMap = {
            brainrot: {
                params: { stability: 1, similarity_boost: 1, speed: 0.9 }
            },
            italian_brainrot: {
                params: { stability: 0.4, similarity_boost: 0.7, speed: 0.90 }
            },
            pirate: {
                params: { speed: 1 }
            },
            shakespeare: {
                params: { stability: 0.6, similarity_boost: 0.75, speed: 0.9 }
            },
            african_american: {
                params: { stability: 0.5, similarity_boost: 0.7, speed: 0.9 }
            },
            matter_of_fact: {
                params: { stability: 0.7, similarity_boost: 0.8, speed: 0.90 }
            },
            sarcastic: {
                params: { stability: 0.7, similarity_boost: 0.8, speed: 0.90 }
            },
            robot_historian: {
                params: { stability: 0.4, similarity_boost: 0.8, speed: 0.90 }
            },
            storyteller: {
                params: { stability: 0.7, similarity_boost: 0.8, speed: 0.9 }
            }
        };
